(function (global, factory) {
    ...
    function create_else_block(ctx) {
    	...
    	function select_block_type_1(ctx, dirty) {
    		if (/*json*/ ctx[2].interactive_nft) return create_if_block_1$1;
    	...
    	return {
    		c() {
    			div = element("div");
    			if_block.c();
    			attr(div, "class", "beyondembeddable__wrapper svelte-nmdk5u");
    			attr(div, "style", div_style_value = `width: ${/*_width*/ ctx[4]}; height: ${/*_height*/ ctx[5]}`);
    			toggle_class(div, "fitContent", /*fitContent*/ ctx[0]);
    		},
    		m(target, anchor) {
    ...
    function create_else_block_1(ctx) {
    	...
    	return {
    		c() {
    			img = element("img");
    			attr(img, "class", "beyondembeddable__fallback svelte-nmdk5u");
    			if (img.src !== (img_src_value = IPFS.process(/*json*/ ctx[2].image))) attr(img, "src", img_src_value);
    		...
    		p(ctx, dirty) {
    			if (dirty & /*json*/ 4 && img.src !== (img_src_value = IPFS.process(/*json*/ ctx[2].image))) {
    ...
    function create_if_block_1$1(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			attr(div, "class", "beyondembeddable__sandbox svelte-nmdk5u");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function makeSandbox() {
    		$$invalidate(2, json.interactive_nft.code_uri = IPFS.process(json.interactive_nft.code_uri), json);
    		...
    		$$invalidate(10, sandbox = new Sandbox({ target: view, props }));
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("fitContent" in $$props) $$invalidate(0, fitContent = $$props.fitContent);
    		if ("width" in $$props) $$invalidate(8, width = $$props.width);
    		if ("height" in $$props) $$invalidate(9, height = $$props.height);
    	};

    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*loaded, view, json, sandbox*/ 1038) {
    ...
    class Token extends SvelteComponent {
    	constructor(options) {
    		super();
    		if (!document.getElementById("svelte-nmdk5u-style")) add_css();
    ...
    /* src/Embeddable.svelte generated by Svelte v3.37.0 */
    ...
    function create_if_block_1(ctx) {
    	...
    	token = new Token({
    			props: {
    				owner: /*owner*/ ctx[0],
    				uris: /*uris*/ ctx[4],
    				fitContent: /*fitContent*/ ctx[1],
    				width: /*width*/ ctx[2],
    				height: /*height*/ ctx[3]
    			}
    		});

    	token.$on("loaded", /*loaded_handler*/ ctx[12]);
    	token.$on("error", /*error_handler*/ ctx[13]);
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*uris*/ 16) token_changes.uris = /*uris*/ ctx[4];
    			if (dirty & /*fitContent*/ 2) token_changes.fitContent = /*fitContent*/ ctx[1];
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*error*/ ctx[6]) return 0;
    		if (/*loaded*/ ctx[5]) return 1;
    		return -1;
    	}
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	async function getURIs() {
    		try {
    			...
    			await proxy.connect();
    			$$invalidate(4, uris = await proxy.uris());
    		} catch(e) {
    	...
    	const error_handler = e => $$invalidate(6, error = e.detail.message);
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("fitContent" in $$props) $$invalidate(1, fitContent = $$props.fitContent);
    		if ("width" in $$props) $$invalidate(2, width = $$props.width);
    		if ("height" in $$props) $$invalidate(3, height = $$props.height);
    		if ("ipfsGateway" in $$props) $$invalidate(10, ipfsGateway = $$props.ipfsGateway);
    	};

    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*contract, tokenId, uris*/ 400) {
    			{
    		...
    		if ($$self.$$.dirty & /*ipfsGateway*/ 1024) {
